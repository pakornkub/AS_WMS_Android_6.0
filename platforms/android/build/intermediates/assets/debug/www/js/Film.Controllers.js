 ...
 * Description
 */
angular.module('Film.Controllers', ['ionic'])


    .controller('Film_NewInCtrl', function ($scope, $ionicPopup, $state, $ionicLoading, $cordovaBarcodeScanner, App, AppService, LoginService, $filter, $ionicScrollDelegate) {
        ...
        /*--------------------------------------
        Call API GetOrderTopic_FilmBangging
        ------------------------------------- */
        $scope.GetOrderTopic_FilmBangging_API = () => {
            ...
            App.API('GetOrderTopic_FilmBangging', {
                ...
                AppService.err('GetOrderTopic_FilmBangging', res);
        ...
        async function searchPallet(dataSearch) {
            try {
                ...
                if ($scope.getTagOrderIndexListLength <= 0) {
                    $scope.data.PalletNo = null;
                ...
                const res_FindLocationAndInsert_NewIn_Film = await FindLocationAndInsert_NewIn_Film(objsession, dataSearch, $scope.data.TF, Qty_Per_Tag, HoldFlag);

                if (res_FindLocationAndInsert_NewIn_Film != 'True') {
                    AppService.err('แจ้งเตือน', res_FindLocationAndInsert_NewIn_Film, '');
                    return;
                }
        ...
        let FindLocationAndInsert_NewIn_Film = (objsession, pstrPallet_No, pstrOrder_Index, pdblQty_Per_Tag, pstrHoldFlag) => {
            return new Promise((resolve, reject) => {

                App.API('FindLocationAndInsert_NewIn_Film', {
                    objsession: objsession,
                    ...
                    reject(AppService.err('FindLocationAndInsert_NewIn_Film', res));
                });
    ...
    .controller('Film_NoNewInCtrl', function ($scope, $ionicPopup, $state, $ionicLoading, $cordovaBarcodeScanner, App, AppService, LoginService, $filter, $ionicScrollDelegate) {
        ...
        /*--------------------------------------
        Call API GetOrderTopic_Film_NoBagging
        ------------------------------------- */
        $scope.GetOrderTopic_Film_NoBagging_API = () => {
            ...
            App.API('GetOrderTopic_Film_NoBagging', {
                objsession: angular.copy(LoginService.getLoginData()),
                pstrWhere: pstrWhere
            }).then(function (res) {
                ...
                AppService.err('GetOrderTopic_Film_NoBagging', res);
            }).finally(function (res) {
                $ionicLoading.hide();
            });
        };
    ...
    .controller('Film_ProductGeneralCtrl', function ($scope, $ionicPopup, $state, $ionicLoading, $cordovaBarcodeScanner, App, AppService, LoginService) {
        ...
        $scope.selected = function (selectedOrder_Index, selectedOrder_No) {
            if (!selectedOrder_Index) {
                ...
                $state.go('film_ProductGeneral_Selected', { Order_Index: selectedOrder_Index, Order_No: selectedOrder_No });
            }
        };

        /*--------------------------------------
        Call API GetOrderTopic_FilmOther
        ------------------------------------- */
        let GetOrderTopic_FilmOther = () => {
            ...
            App.API('GetOrderTopic_FilmOther', {
                objsession: angular.copy(LoginService.getLoginData()),
                pstrWhere: strWhere
            }).then(function (res) {
                ...
                AppService.err('GetOrderTopic_FilmOther', res);
            }).finally(function (res) {
                $ionicLoading.hide();
            });
        };

        GetOrderTopic_FilmOther();

    })

    .controller('Film_ProductGeneral_SelectedCtrl', function ($scope, $ionicPopup, $state, $ionicLoading, $cordovaBarcodeScanner, App, AppService, LoginService, $stateParams, $ionicHistory) {
        ...
        let getTag_Receive = () => {
            ...
            App.API('getTag_Receive', {
                ...
                $scope.data.PalletCount = countStatus + '/' + $scope.datatablesList.length;
        ...
        async function searchPallet(dataSearch) {
            try {
                ...
                const res_FindLocationAndInsert_NewIn_Film = await FindLocationAndInsert_NewIn_Film(objsession, dataSearch, Order_Index, $scope.data.TotalQty, '');
