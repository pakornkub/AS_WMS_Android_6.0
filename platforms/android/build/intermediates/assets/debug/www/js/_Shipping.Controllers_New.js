                    ...
                    //for(var n in resFind){
                        ...
                        if(resFind[n]['WITHDRAWITEM-STATUS'] == '-9' || resFind[n]['WITHDRAWITEM-STATUS'] == '-10'){
                            ...
                            App.API('CHEKPICK_WITHDRAWITEM_STATUS', { 
                                ...
                                //var CHEKPICK_WITHDRAWITEM_STATUS_555 = (!res['diffgr:diffgram']) ? {} : res['diffgr:diffgram'].NewDataSet.Table1[0];   
                                //console.log('CHEKPICK_WITHDRAWITEM_STATUS_555::::',CHEKPICK_WITHDRAWITEM_STATUS_555); 
                                if(res === true){
                                    isError = true;
                                    ...
                                    //console.log('CHEKPICK_WITHDRAWITEM_STATUS วนครั้งที่:',k);
                                    //Call save pick item
                                //for(var x in $scope.getWithdrawItemList){     
                                    App.API('SavePickSavePickItem_Withdraw', { 
                                        objsession: angular.copy(LoginService.getLoginData()), 
